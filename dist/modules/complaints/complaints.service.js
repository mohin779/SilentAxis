...
async function submitComplaint(input) {
    ...
    const existing = await db_1.pool.query("SELECT 1 FROM nullifiers WHERE nullifier_hash = $1", [
        input.nullifierHash
    ]);
    ...
    await db_1.pool.query("INSERT INTO nullifiers (nullifier_hash) VALUES ($1)", [input.nullifierHash]);
